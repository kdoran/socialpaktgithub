...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cart_cart', 'checked_out')


    def backwards(self, orm):
        
        # Adding field 'Cart.checked_out'
        db.add_column('cart_cart', 'checked_out', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    models = {
        ...
        'cart.cart': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'cart'", 'unique': 'True', 'null': 'True', 'to': "orm['auth.User']"})
        },
        'cart.item': {
