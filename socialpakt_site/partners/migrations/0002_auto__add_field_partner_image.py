...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('partners_partner', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Partner.image'
        db.delete_column('partners_partner', 'image')
