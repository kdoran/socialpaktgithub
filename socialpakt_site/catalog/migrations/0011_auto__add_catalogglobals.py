...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CatalogGlobals'
        db.create_table('catalog_catalogglobals', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('global_set', self.gf('django.db.models.fields.SlugField')(max_length=255, db_index=True)),
            ('default_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ProductCategory'])),
        ))
        db.send_create_signal('catalog', ['CatalogGlobals'])


    def backwards(self, orm):
        
        # Deleting model 'CatalogGlobals'
        db.delete_table('catalog_catalogglobals')
    ...
    models = {
        'catalog.catalogglobals': {
            ...
            'global_set': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'db_index': 'True'}),
