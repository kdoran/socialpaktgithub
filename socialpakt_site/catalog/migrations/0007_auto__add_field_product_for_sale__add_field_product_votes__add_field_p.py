...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.for_sale'
        db.add_column('catalog_product', 'for_sale', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Product.votes'
        db.add_column('catalog_product', 'votes', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ProductVariation.inventory'
        db.add_column('catalog_productvariation', 'inventory', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)

        # Adding field 'ProductVariation.price_override'
        db.add_column('catalog_productvariation', 'price_override', self.gf('django.db.models.fields.FloatField')(default=-1.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.for_sale'
        db.delete_column('catalog_product', 'for_sale')

        # Deleting field 'Product.votes'
        db.delete_column('catalog_product', 'votes')

        # Deleting field 'ProductVariation.inventory'
        db.delete_column('catalog_productvariation', 'inventory')

        # Deleting field 'ProductVariation.price_override'
        db.delete_column('catalog_productvariation', 'price_override')
