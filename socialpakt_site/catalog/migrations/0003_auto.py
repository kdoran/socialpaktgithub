...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Product', fields ['date_expires']
        db.create_index('catalog_product', ['date_expires'])


    def backwards(self, orm):
        
        # Removing index on 'Product', fields ['date_expires']
        db.delete_index('catalog_product', ['date_expires'])
