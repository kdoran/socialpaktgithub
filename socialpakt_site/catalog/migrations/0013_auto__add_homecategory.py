...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HomeCategory'
        db.create_table('catalog_homecategory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, db_index=True)),
            ('display_text', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.ProductCategory'], null=True)),
        ))
        db.send_create_signal('catalog', ['HomeCategory'])


    def backwards(self, orm):
        
        # Deleting model 'HomeCategory'
        db.delete_table('catalog_homecategory')
