...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.estimated_ship_date'
        db.add_column('catalog_product', 'estimated_ship_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now, db_index=True),
                      keep_default=False)

        # Adding field 'Product.artist_donating'
        db.add_column('catalog_product', 'artist_donating',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Product.tweet'
        db.alter_column('catalog_product', 'tweet', self.gf('django.db.models.fields.CharField')(max_length=90))

    def backwards(self, orm):
        # Deleting field 'Product.estimated_ship_date'
        db.delete_column('catalog_product', 'estimated_ship_date')

        # Deleting field 'Product.artist_donating'
        db.delete_column('catalog_product', 'artist_donating')


        # Changing field 'Product.tweet'
        db.alter_column('catalog_product', 'tweet', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'catalog.product': {
            ...
            'artist_donating': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'estimated_ship_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'}),
            ...
            'tweet': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '90', 'blank': 'True'}),
